        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-semibold mb-4">{{ __("Formulario de Creación de Obra") }}</h3>

                    <div>
                        <form action="{{ route('work.store') }}" method="POST">
                            @csrf

                            @if ($errors->any() && !$errors->hasAny(['name', 'province_id', 'start_date', 'end_date_planned', 'description']))
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date"
                                       class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 sm:text-sm"
                                       id="end_date_planned" name="end_date_planned" value="{{ old('end_date_planned') }}" required>
