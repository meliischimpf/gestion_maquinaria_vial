                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div>
                        <form action="{{ route('machine.update', $machine->id) }}" method="POST">
                            ...
                            @if ($errors->any() && !$errors->hasAny(['serial_number', 'type_id', 'brand', 'model', 'status_id', 'current_km', 'lifetime_km']))
                            ...
                            <div class="mb-4">
                                ...
                                <input placeholder="ABC-1234" type="text"
                                       ...
                                       id="serial_number" name="serial_number" value="{{ old('serial_number', $machine->serial_number) }}" required>
                                @error('serial_number')
                            ...
                            <div class="mb-4">
                                ...
                                <select class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 sm:text-sm"
                                    ...
                                    @foreach ($types as $type)
                                        <option value="{{ $type->id }}" {{ (old('type_id', $machine->type_id) == $type->id) ? 'selected' : '' }}>
                                            {{ $type->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text"
                                       class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 sm:text-sm"
                                       id="brand" name="brand" value="{{ old('brand', $machine->brand) }}" required>
                                @error('brand')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text"
                                       class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 sm:text-sm"
                                       id="model" name="model" value="{{ old('model', $machine->model) }}" required>
                                @error('model')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 sm:text-sm"
                                    ...
                                    @foreach ($statuses as $status)
                                        <option value="{{ $status->id }}" {{ (old('status_id', $machine->status_id) == $status->id) ? 'selected' : '' }}>
                                            {{ $status->situation }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number"
                                       class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 sm:text-sm"
                                       id="current_km" name="current_km" value="{{ old('current_km', $machine->current_km) }}" required min="0">
                                @error('current_km')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <input type="number"
                                       class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 sm:text-sm"
                                       id="lifetime_km" name="lifetime_km" value="{{ old('lifetime_km', $machine->lifetime_km) }}" required min="0">
                                @error('lifetime_km')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
