        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-semibold mb-4">{{ __("Formulario de Actualización de Asignación") }}</h3>
                        ...
                        <form action="{{ route('assignment.update', $assignment->id) }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date"
                                       ...
                                       id="start_date" name="start_date" value="{{ old('start_date', $assignment->start_date) }}" required>
                                @error('start_date')
